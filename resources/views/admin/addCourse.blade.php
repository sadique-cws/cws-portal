           ...
           <form action="{{route('course.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-3 gap-4 px-32 py-5">
                ...
                <div class="mb-3 flex flex-col">
                    ...
                    <input type="number" name="duration" class="border border-gray-400 py-2 px-1 rounded">
                </div>
                <div class="mb-3 flex flex-col">
                    <label for="">price</label>
                    <input type="number" name="price" class="border border-gray-400 py-2 px-1 rounded" placeholder="enter price">
                </div> 
                <div class="mb-3 flex flex-col">
                ...
                <div class="mb-3 flex flex-col col-span-2">
                ...
                <div class="mb-3 flex flex-col">
                    <input type="submit" class="bg-green-800 hover:bg-green-900 text-white px-3 py-2 text-2xl">
                </div>
            </div>
           </form>
        </div>
